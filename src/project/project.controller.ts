...
export class ProjectController {
    ...
    // 과제 정보 등록
    @Post('/')
    async creaeteProject(@Res() res: Response, @Body() projectInfo: CreateProjectDto) {
        try {
    ...
    //과제 정보 수정
    @Put()
    async updateProject(@Res() res: Response, @Body() projectInfo: UpdateProjectDto) {
        try {
    ...
    //과제 정보 삭제
    @Delete('/:project_id')
    async deleteProject(@Res() res: Response, @Param('project_id') project_id: string) {
        try {
